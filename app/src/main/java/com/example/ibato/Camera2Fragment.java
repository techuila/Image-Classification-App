        ...
        View.OnClickListener
{
    ...
    private RelativeLayout mStillshotContainer, mFlashContainer, mSwitchOrientationContainer, mMenuContainer,
            mCaptureBtnContainer, mCloseStillshotContainer, mSaveContainer;
            ...
            public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Model model = new Model(mIMainActivity.getUserID(), uri.toString(), "Carrots", "Carrots can be eaten something chu chu", true);
